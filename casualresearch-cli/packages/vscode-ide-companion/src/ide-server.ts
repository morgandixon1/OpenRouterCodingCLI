...
import { IdeContextNotificationSchema } from '@google/casualresearch-cli-core';
...
const IDE_SERVER_PORT_ENV_VAR = 'casualresearch_CLI_IDE_SERVER_PORT';
...
const createMcpServer = (diffManager: DiffManager) => {
  const server = new McpServer(
    {
      name: 'casualresearch-cli-companion-mcp-server',
      version: '1.0.0',
    },
