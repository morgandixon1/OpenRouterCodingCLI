...
export type EventValue = {
  casualresearch_cli_key: EventMetadataKey | string;
  value: string;
};
 ...
 * distribution channel in which the user is using casualresearch CLI.  casualresearch CLI comes bundled
...
export class ClearcutLogger {
  ...
  createLogEvent(name: string, data: EventValue[]): LogEvent {
    ...
    data.push({
      casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_GOOGLE_ACCOUNTS_COUNT,
      value: totalAccounts.toString(),
    });

    const logEvent: LogEvent = {
      console_type: 'casualresearch_CLI',
      application: 102,
      event_name: name,
      event_metadata: [data],
    };
  ...
  logStartSessionEvent(event: StartSessionEvent): void {
    ...
    const data: EventValue[] = [
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_START_SESSION_MODEL,
        value: event.model,
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_SESSION_ID,
        value: this.config?.getSessionId() ?? '',
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_START_SESSION_EMBEDDING_MODEL,
        value: event.embedding_model,
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_START_SESSION_SANDBOX,
        value: event.sandbox_enabled.toString(),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_START_SESSION_CORE_TOOLS,
        value: event.core_tools_enabled,
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_START_SESSION_APPROVAL_MODE,
        value: event.approval_mode,
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_START_SESSION_API_KEY_ENABLED,
        value: event.api_key_enabled.toString(),
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_START_SESSION_VERTEX_API_ENABLED,
        value: event.vertex_ai_enabled.toString(),
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_START_SESSION_DEBUG_MODE_ENABLED,
      ...
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_START_SESSION_MCP_SERVERS,
      ...
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_START_SESSION_TELEMETRY_ENABLED,
        value: event.telemetry_enabled.toString(),
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_START_SESSION_TELEMETRY_LOG_USER_PROMPTS_ENABLED,
        value: event.telemetry_log_user_prompts_enabled.toString(),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_SURFACE,
        value: surface,
      },
    ];
  ...
  logNewPromptEvent(event: UserPromptEvent): void {
    const data: EventValue[] = [
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_USER_PROMPT_LENGTH,
      ...
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_PROMPT_ID,
        value: JSON.stringify(event.prompt_id),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_AUTH_TYPE,
  ...
  logToolCallEvent(event: ToolCallEvent): void {
    const data: EventValue[] = [
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_TOOL_CALL_NAME,
      ...
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_TOOL_CALL_DECISION,
        value: JSON.stringify(event.decision),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_TOOL_CALL_SUCCESS,
        value: JSON.stringify(event.success),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_TOOL_CALL_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_TOOL_ERROR_MESSAGE,
        value: JSON.stringify(event.error),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_TOOL_CALL_ERROR_TYPE,
    ...
    if (event.metadata) {
      const metadataMapping: { [key: string]: EventMetadataKey } = {
        ai_added_lines: EventMetadataKey.casualresearch_CLI_AI_ADDED_LINES,
        ai_removed_lines: EventMetadataKey.casualresearch_CLI_AI_REMOVED_LINES,
        user_added_lines: EventMetadataKey.casualresearch_CLI_USER_ADDED_LINES,
        user_removed_lines: EventMetadataKey.casualresearch_CLI_USER_REMOVED_LINES,
      };

      for (const [key, casualresearch_cli_key] of Object.entries(metadataMapping)) {
  ...
  logApiRequestEvent(event: ApiRequestEvent): void {
    const data: EventValue[] = [
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_API_REQUEST_MODEL,
  ...
  logApiResponseEvent(event: ApiResponseEvent): void {
    const data: EventValue[] = [
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_API_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_PROMPT_ID,
      ...
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_API_RESPONSE_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_API_RESPONSE_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_API_ERROR_MESSAGE,
        value: JSON.stringify(event.error),
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_API_RESPONSE_INPUT_TOKEN_COUNT,
        value: JSON.stringify(event.input_token_count),
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT,
        value: JSON.stringify(event.output_token_count),
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_API_RESPONSE_CACHED_TOKEN_COUNT,
        value: JSON.stringify(event.cached_content_token_count),
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_API_RESPONSE_THINKING_TOKEN_COUNT,
        value: JSON.stringify(event.thoughts_token_count),
      },
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_API_RESPONSE_TOOL_TOKEN_COUNT,
  ...
  logApiErrorEvent(event: ApiErrorEvent): void {
    const data: EventValue[] = [
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_API_ERROR_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_PROMPT_ID,
      ...
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_API_ERROR_TYPE,
        value: JSON.stringify(event.error_type),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_API_ERROR_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_API_ERROR_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_AUTH_TYPE,
  ...
  logLoopDetectedEvent(event: LoopDetectedEvent): void {
    const data: EventValue[] = [
      ...
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_LOOP_DETECTED_TYPE,
  ...
  logNextSpeakerCheck(event: NextSpeakerCheckEvent): void {
    const data: EventValue[] = [
      ...
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_RESPONSE_FINISH_REASON,
        value: JSON.stringify(event.finish_reason),
      },
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_NEXT_SPEAKER_CHECK_RESULT,
  ...
  logSlashCommandEvent(event: SlashCommandEvent): void {
    const data: EventValue[] = [
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_SLASH_COMMAND_NAME,
    ...
    if (event.subcommand) {
      data.push({
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_SLASH_COMMAND_SUBCOMMAND,
  ...
  logMalformedJsonResponseEvent(event: MalformedJsonResponseEvent): void {
    const data: EventValue[] = [
      {
        casualresearch_cli_key:
          EventMetadataKey.casualresearch_CLI_MALFORMED_JSON_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
    ];
  ...
  logIdeConnectionEvent(event: IdeConnectionEvent): void {
    const data: EventValue[] = [
      {
        casualresearch_cli_key: EventMetadataKey.casualresearch_CLI_IDE_CONNECTION_TYPE,
