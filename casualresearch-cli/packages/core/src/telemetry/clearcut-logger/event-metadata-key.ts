...
export enum EventMetadataKey {
  casualresearch_CLI_KEY_UNKNOWN = 0,
  ...
  casualresearch_CLI_START_SESSION_MODEL = 1,

  // Logs the embedding model id used in the session.
  casualresearch_CLI_START_SESSION_EMBEDDING_MODEL = 2,

  // Logs the sandbox that was used in the session.
  casualresearch_CLI_START_SESSION_SANDBOX = 3,

  // Logs the core tools that were enabled in the session.
  casualresearch_CLI_START_SESSION_CORE_TOOLS = 4,

  // Logs the approval mode that was used in the session.
  casualresearch_CLI_START_SESSION_APPROVAL_MODE = 5,

  // Logs whether an API key was used in the session.
  casualresearch_CLI_START_SESSION_API_KEY_ENABLED = 6,

  // Logs whether the Vertex API was used in the session.
  casualresearch_CLI_START_SESSION_VERTEX_API_ENABLED = 7,

  // Logs whether debug mode was enabled in the session.
  casualresearch_CLI_START_SESSION_DEBUG_MODE_ENABLED = 8,

  // Logs the MCP servers that were enabled in the session.
  casualresearch_CLI_START_SESSION_MCP_SERVERS = 9,

  // Logs whether user-collected telemetry was enabled in the session.
  casualresearch_CLI_START_SESSION_TELEMETRY_ENABLED = 10,

  // Logs whether prompt collection was enabled for user-collected telemetry.
  casualresearch_CLI_START_SESSION_TELEMETRY_LOG_USER_PROMPTS_ENABLED = 11,

  // Logs whether the session was configured to respect gitignore files.
  casualresearch_CLI_START_SESSION_RESPECT_GITIGNORE = 12,
  ...
  casualresearch_CLI_USER_PROMPT_LENGTH = 13,
  ...
  casualresearch_CLI_TOOL_CALL_NAME = 14,

  // Logs the user's decision about how to handle the tool call.
  casualresearch_CLI_TOOL_CALL_DECISION = 15,

  // Logs whether the tool call succeeded.
  casualresearch_CLI_TOOL_CALL_SUCCESS = 16,

  // Logs the tool call duration in milliseconds.
  casualresearch_CLI_TOOL_CALL_DURATION_MS = 17,

  // Logs the tool call error message, if any.
  casualresearch_CLI_TOOL_ERROR_MESSAGE = 18,

  // Logs the tool call error type, if any.
  casualresearch_CLI_TOOL_CALL_ERROR_TYPE = 19,
  ...
  casualresearch_CLI_API_REQUEST_MODEL = 20,
  ...
  casualresearch_CLI_API_RESPONSE_MODEL = 21,

  // Logs the status code of the response.
  casualresearch_CLI_API_RESPONSE_STATUS_CODE = 22,

  // Logs the duration of the API call in milliseconds.
  casualresearch_CLI_API_RESPONSE_DURATION_MS = 23,

  // Logs the error message of the API call, if any.
  casualresearch_CLI_API_ERROR_MESSAGE = 24,

  // Logs the input token count of the API call.
  casualresearch_CLI_API_RESPONSE_INPUT_TOKEN_COUNT = 25,

  // Logs the output token count of the API call.
  casualresearch_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT = 26,

  // Logs the cached token count of the API call.
  casualresearch_CLI_API_RESPONSE_CACHED_TOKEN_COUNT = 27,

  // Logs the thinking token count of the API call.
  casualresearch_CLI_API_RESPONSE_THINKING_TOKEN_COUNT = 28,

  // Logs the tool use token count of the API call.
  casualresearch_CLI_API_RESPONSE_TOOL_TOKEN_COUNT = 29,
  ...
  // Logs the model id of the API call.
  casualresearch_CLI_API_ERROR_MODEL = 30,

  // Logs the error type.
  casualresearch_CLI_API_ERROR_TYPE = 31,

  // Logs the status code of the error response.
  casualresearch_CLI_API_ERROR_STATUS_CODE = 32,

  // Logs the duration of the API call in milliseconds.
  casualresearch_CLI_API_ERROR_DURATION_MS = 33,
  ...
  casualresearch_CLI_END_SESSION_ID = 34,
  ...
  // Logs the Prompt Id
  casualresearch_CLI_PROMPT_ID = 35,

  // Logs the Auth type for the prompt, api responses and errors.
  casualresearch_CLI_AUTH_TYPE = 36,

  // Logs the total number of Google accounts ever used.
  casualresearch_CLI_GOOGLE_ACCOUNTS_COUNT = 37,

  // Logs the Surface from where the casualresearch CLI was invoked, eg: VSCode.
  casualresearch_CLI_SURFACE = 39,

  // Logs the session id
  casualresearch_CLI_SESSION_ID = 40,
  ...
  casualresearch_CLI_LOOP_DETECTED_TYPE = 38,
  ...
  casualresearch_CLI_SLASH_COMMAND_NAME = 41,

  // Logs the subcommand of the slash command.
  casualresearch_CLI_SLASH_COMMAND_SUBCOMMAND = 42,
  ...
  casualresearch_CLI_RESPONSE_FINISH_REASON = 43,

  // Logs the result of the next speaker check
  casualresearch_CLI_NEXT_SPEAKER_CHECK_RESULT = 44,
  ...
  casualresearch_CLI_MALFORMED_JSON_RESPONSE_MODEL = 45,
