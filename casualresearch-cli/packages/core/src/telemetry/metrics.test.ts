...
describe('Telemetry Metrics', () => {
  ...
  describe('recordTokenUsageMetrics', () => {
    ...
    it('should not record metrics if not initialized', () => {
      recordTokenUsageMetricsModule(mockConfig, 'casualresearch-pro', 100, 'input');
    ...
    it('should record token usage for different types', () => {
      ...
      recordTokenUsageMetricsModule(mockConfig, 'casualresearch-pro', 50, 'output');
      ...
      recordTokenUsageMetricsModule(mockConfig, 'casualresearch-pro', 25, 'thought');
      ...
      recordTokenUsageMetricsModule(mockConfig, 'casualresearch-pro', 75, 'cache');
      ...
      recordTokenUsageMetricsModule(mockConfig, 'casualresearch-pro', 125, 'tool');
    ...
    it('should handle different models', () => {
      ...
      recordTokenUsageMetricsModule(mockConfig, 'casualresearch-ultra', 200, 'input');
      expect(mockCounterAddFn).toHaveBeenCalledWith(200, {
        'session.id': 'test-session-id',
        model: 'casualresearch-ultra',
        type: 'input',
      });
    });
  });
