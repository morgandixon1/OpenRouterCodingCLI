...
export interface LoadCodeAssistResponse {
  currentTier?: casualresearchUserTier | null;
  allowedTiers?: casualresearchUserTier[] | null;
  ineligibleTiers?: IneligibleTier[] | null;
  cloudaicompanionProject?: string | null;
}

/**
 * casualresearchUserTier reflects the structure received from the CodeAssist when calling LoadCodeAssist.
 */
export interface casualresearchUserTier {
  id: UserTierId;
  name: string;
  description: string;
...
/**
 * Status of user onboarded to casualresearch
 */
