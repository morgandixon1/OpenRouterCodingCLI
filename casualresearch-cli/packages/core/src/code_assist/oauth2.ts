...
// Note: Replace with your actual OAuth client ID from Google Cloud Console
const OAUTH_CLIENT_ID = process.env.GOOGLE_OAUTH_CLIENT_ID || 'YOUR_OAUTH_CLIENT_ID';

// OAuth Secret value used to initiate OAuth2Client class.
// Note: Replace with your actual OAuth client secret from Google Cloud Console
// For production, use environment variables instead of hardcoded values
const OAUTH_CLIENT_SECRET = process.env.GOOGLE_OAUTH_CLIENT_SECRET || 'YOUR_OAUTH_CLIENT_SECRET';
...
const SIGN_IN_SUCCESS_URL =
  'https://developers.google.com/casualresearch-code-assist/auth_success_casualresearch';
const SIGN_IN_FAILURE_URL =
  'https://developers.google.com/casualresearch-code-assist/auth_failure_casualresearch';

const casualresearch_DIR = '.casualresearch';
...
function getCachedCredentialPath(): string {
  return path.join(os.homedir(), casualresearch_DIR, CREDENTIAL_FILENAME);
}
