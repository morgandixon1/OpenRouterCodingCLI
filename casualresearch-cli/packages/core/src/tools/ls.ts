    ...
    super(
      ...
      Icon.Folder,
      {
        properties: {
          ...
          file_filtering_options: {
            description:
              'Optional: Whether to respect ignore patterns from .gitignore or .casualresearchignore',
            type: Type.OBJECT,
            properties: {
              respect_git_ignore: {
                description:
    ...
    try {
      ...
      const fileFilteringOptions = {
        ...
        respectcasualresearchIgnore:
          ...
          defaultFileIgnores.respectcasualresearchIgnore,
      };
      ...
      for (const file of files) {
        ...
        // Check if this file should be ignored based on git or casualresearch ignore rules
        if (
        ...
        if (
          ...
          fileDiscovery.shouldcasualresearchIgnoreFile(relativePath)
        ) {
      ...
      if (casualresearchIgnoredCount > 0) {
        ignoredMessages.push(`${casualresearchIgnoredCount} casualresearch-ignored`);
      }
