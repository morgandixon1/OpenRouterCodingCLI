  ...
  async execute(
    ...
    try {
      ...
      const llmSuccessMessageParts = [
        isNewFile
          ? `✓ TASK COMPLETED: Successfully created and wrote to new file: ${params.file_path}. The file creation task is now complete.`
          : `✓ TASK COMPLETED: Successfully overwrote file: ${params.file_path}. The file writing task is now complete.`,
      ];
