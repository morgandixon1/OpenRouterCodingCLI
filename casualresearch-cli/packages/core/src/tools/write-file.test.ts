...
const rootDir = path.resolve(os.tmpdir(), 'casualresearch-cli-test-root');
...
const mockConfigInternal = {
  ...
  getcasualresearchClient: vi.fn(), // Initialize as a plain mock function
  getIdeClient: vi.fn(),
  ...
  getUserMemory: () => '',
  setUserMemory: vi.fn(),
  getcasualresearchMdFileCount: () => 0,
...
describe('WriteFileTool', () => {
  ...
  beforeEach(() => {
    ...
    // Setup casualresearchClient mock
    mockcasualresearchClientInstance = new (vi.mocked(casualresearchClient))(
      mockConfig,
    ) as Mocked<casualresearchClient>;
    vi.mocked(casualresearchClient).mockImplementation(() => mockcasualresearchClientInstance);
    ...
    // Now that mockcasualresearchClientInstance is initialized, set the mock implementation for getcasualresearchClient
    mockConfigInternal.getcasualresearchClient.mockReturnValue(
