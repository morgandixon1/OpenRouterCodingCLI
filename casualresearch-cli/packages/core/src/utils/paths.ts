...
export const casualresearch_DIR = '.casualresearch';
...
export function getProjectTempDir(projectRoot: string): string {
  ...
  return path.join(os.homedir(), casualresearch_DIR, TMP_DIR_NAME, hash);
}
...
export function getUserCommandsDir(): string {
  return path.join(os.homedir(), casualresearch_DIR, COMMANDS_DIR_NAME);
}
...
export function getProjectCommandsDir(projectRoot: string): string {
  return path.join(projectRoot, casualresearch_DIR, COMMANDS_DIR_NAME);
}
