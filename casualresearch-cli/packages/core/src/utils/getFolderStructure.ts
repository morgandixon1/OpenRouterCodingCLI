      ...
      if (entry.isFile()) {
        ...
        if (options.fileService) {
          const shouldIgnore =
            ...
            (options.fileFilteringOptions.respectcasualresearchIgnore &&
              options.fileService.shouldcasualresearchIgnoreFile(filePath));
          if (shouldIgnore) {
            continue;
          }
        }
      ...
      if (entry.isDirectory()) {
        ...
        if (options.fileService) {
          isIgnored =
            ...
            (options.fileFilteringOptions.respectcasualresearchIgnore &&
              options.fileService.shouldcasualresearchIgnoreFile(subFolderPath));
        }
