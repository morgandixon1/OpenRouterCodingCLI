...
describe('summarizers', () => {
  ...
  beforeEach(() => {
    ...
    (mockcasualresearchClient.generateContent as Mock) = vi.fn();
  ...
  describe('summarizeToolOutput', () => {
    it('should return original text if it is shorter than maxLength', async () => {
      ...
      expect(mockcasualresearchClient.generateContent).not.toHaveBeenCalled();
    });
    ...
    it('should call generateContent if text is longer than maxLength', async () => {
      ...
      (mockcasualresearchClient.generateContent as Mock).mockResolvedValue({
      ...
      expect(mockcasualresearchClient.generateContent).toHaveBeenCalledTimes(1);
    ...
    it('should return original text if generateContent throws an error', async () => {
      ...
      (mockcasualresearchClient.generateContent as Mock).mockRejectedValue(error);
    ...
    it('should construct the correct prompt for summarization', async () => {
      ...
      await summarizeToolOutput(longText, mockcasualresearchClient, abortSignal, 1000);
...
`;
      const calledWith = (mockcasualresearchClient.generateContent as Mock).mock
        .calls[0];
