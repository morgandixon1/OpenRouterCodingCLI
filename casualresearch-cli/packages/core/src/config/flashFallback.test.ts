...
import { DEFAULT_casualresearch_MODEL, DEFAULT_casualresearch_FLASH_MODEL } from './models.js';
...
describe('Flash Model Fallback Configuration', () => {
  ...
  describe('setModel', () => {
    it('should only mark as switched if contentGeneratorConfig exists', () => {
      ...
      newConfig.setModel(DEFAULT_casualresearch_FLASH_MODEL);
  ...
  describe('getModel', () => {
    it('should return contentGeneratorConfig model if available', () => {
      ...
      config.setModel(DEFAULT_casualresearch_FLASH_MODEL);
      expect(config.getModel()).toBe(DEFAULT_casualresearch_FLASH_MODEL);
    });
