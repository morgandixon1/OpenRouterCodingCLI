...
import { getProjectHash, casualresearch_DIR } from '../utils/paths.js';
...
export class GitService {
  ...
  private getHistoryDir(): string {
    ...
    return path.join(os.homedir(), casualresearch_DIR, 'history', hash);
  }
  ...
  async setupShadowGitRepository() {
    ...
    const gitConfigContent =
      '[user]\n  name = casualresearch CLI\n  email = casualresearch-cli@google.com\n[commit]\n  gpgsign = false\n';
