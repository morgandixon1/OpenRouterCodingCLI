...
import { Config, FileSearch, escapePath } from '@google/casualresearch-cli-core';
import {
  Suggestion,
    ...
    const initialize = async () => {
      try {
        const searcher = new FileSearch({
          ...
          usecasualresearchignore:
            config?.getFileFilteringOptions()?.respectcasualresearchIgnore ?? true,
          cache: true,
