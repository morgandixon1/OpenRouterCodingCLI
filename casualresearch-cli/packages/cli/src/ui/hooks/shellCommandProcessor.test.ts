...
describe('useShellCommandProcessor', () => {
  ...
  beforeEach(() => {
    ...
    mockcasualresearchClient = { addHistory: vi.fn() } as unknown as casualresearchClient;
  ...
  it('should handle successful execution and update history correctly', async () => {
    ...
    expect(mockcasualresearchClient.addHistory).toHaveBeenCalled();
  });
