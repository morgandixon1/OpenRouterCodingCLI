...
import { usecasualresearchStream, mergePartListUnions } from './usecasualresearchStream.js';
...
const MockedcasualresearchClientClass = vi.hoisted(() =>
...
vi.mock('@google/casualresearch-cli-core', async (importOriginal) => {
  ...
  return {
    ...actualCoreModule,
    GitService: vi.fn(),
    casualresearchClient: MockedcasualresearchClientClass,
...
// --- Tests for usecasualresearchStream Hook ---
describe('usecasualresearchStream', () => {
  ...
  beforeEach(() => {
    ...
    mockAddItem = vi.fn();
    // Define the mock for getcasualresearchClient
    const mockGetcasualresearchClient = vi.fn().mockImplementation(() => {
      // MockedcasualresearchClientClass is defined in the module scope by the previous change.
      // It will use the mockStartChat and mockSendMessageStream that are managed within beforeEach.
      const clientInstance = new MockedcasualresearchClientClass(mockConfig);
    ...
    const contentGeneratorConfig = {
      ...
      apiKey: 'test-key',
      vertexai: false,
      authType: AuthType.USE_casualresearch,
    };

    mockConfig = {
      apiKey: 'test-api-key',
      model: 'casualresearch-pro',
      sandbox: false,
      targetDir: '/test/dir',
      debugMode: false,
      question: undefined,
      ...
      getcasualresearchClient: mockGetcasualresearchClient,
      ...
      getModel: vi.fn(() => 'casualresearch-2.5-pro'),
    ...
    // Reset mocks for casualresearchClient instance methods (startChat and sendMessageStream)
    // The casualresearchClient constructor itself is mocked at the module level.
    mockStartChat.mockClear().mockResolvedValue({
      sendMessageStream: mockSendMessageStream,
    } as unknown as any); // casualresearchChat -> any
  ...
  const mockLoadedSettings: LoadedSettings = {
    ...
    workspace: { path: '/workspace/.casualresearch/settings.json', settings: {} },
    errors: [],
    forScope: vi.fn(),
    setValue: vi.fn(),
  ...
  const renderTestHook = (
    ...
    const client = casualresearchClient || mockConfig.getcasualresearchClient();
    ...
    const { result, rerender } = renderHook(
      (props: {
        ...
        return usecasualresearchStream(
          props.client,
          props.history,
          props.addItem,
          props.config,
    ...
    const toolCalls: TrackedToolCall[] = [
      {
        ...
        status: 'success',
        responseSubmittedTocasualresearch: false,
        response: {
          callId: 'call1',
  ...
  it('should submit tool responses when all tool calls are completed and ready', async () => {
    ...
    renderHook(() =>
      usecasualresearchStream(
        new MockedcasualresearchClientClass(mockConfig),
        [],
        mockAddItem,
        mockConfig,
        mockOnDebugMessage,
  ...
  it('should handle all tool calls being cancelled', async () => {
    ...
    const client = new MockedcasualresearchClientClass(mockConfig);
  ...
  describe('User Cancellation', () => {
    ...
    it('should call onCancelSubmit handler when escape is pressed', async () => {
      ...
      const { result } = renderHook(() =>
        usecasualresearchStream(
          mockConfig.getcasualresearchClient(),
          [],
          mockAddItem,
          mockConfig,
          mockOnDebugMessage,
    ...
    it('should prevent further processing after cancellation', async () => {
      ...
      const lastCall = mockAddItem.mock.calls.find(
        (call) => call[0].type === 'casualresearch',
      );
  ...
  describe('Slash Command Handling', () => {
    ...
    it('should stop processing and not call casualresearch when a command is handled without a tool call', async () => {
    ...
    it('should call casualresearch with prompt content when slash command returns a `submit_prompt` action', async () => {
  ...
  describe('Error Handling', () => {
    it('should call parseAndFormatApiError with the correct authType on stream initialization failure', async () => {
      ...
      const { result } = renderHook(() =>
        usecasualresearchStream(
          new MockedcasualresearchClientClass(testConfig),
          [],
          mockAddItem,
          testConfig,
          mockOnDebugMessage,
      ...
      await waitFor(() => {
        expect(mockParseAndFormatApiError).toHaveBeenCalledWith(
          ...
          mockAuthType,
          undefined,
          'casualresearch-2.5-pro',
          'casualresearch-2.5-flash',
        );
      });
    });
  });
  ...
  describe('handleFinishedEvent', () => {
    it('should add info message for MAX_TOKENS finish reason', async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          yield {
            type: ServercasualresearchEventType.Content,
            value: 'This is a truncated response...',
          };
          yield { type: ServercasualresearchEventType.Finished, value: 'MAX_TOKENS' };
        })(),
      );
    ...
    it('should not add message for STOP finish reason', async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          ...
          yield { type: ServercasualresearchEventType.Finished, value: 'STOP' };
        })(),
      );
    ...
    it('should not add message for FINISH_REASON_UNSPECIFIED', async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          ...
          yield {
            type: ServercasualresearchEventType.Finished,
      ...
      for (const { reason, message } of testCases) {
        ...
        mockSendMessageStream.mockReturnValue(
          (async function* () {
            ...
            yield { type: ServercasualresearchEventType.Finished, value: reason };
          })(),
        );
  ...
  describe('Thought Reset', () => {
    it('should reset thought to null when starting a new prompt', async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          yield {
            type: ServercasualresearchEventType.Thought,
            value: {
    ...
    it('should reset thought to null when user cancels', async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          ...
          yield { type: ServercasualresearchEventType.UserCancelled };
        })(),
      );
    ...
    it('should reset thought to null when there is an error', async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          ...
          yield {
            type: ServercasualresearchEventType.Error,
