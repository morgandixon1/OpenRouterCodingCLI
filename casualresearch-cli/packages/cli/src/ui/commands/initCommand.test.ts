...
describe('initCommand', () => {
  ...
  it('should inform the user if casualresearch.md already exists', async () => {
  ...
  it('should create casualresearch.md and submit a prompt if it does not exist', async () => {
    ...
    expect(fs.writeFileSync).toHaveBeenCalledWith(casualresearchMdPath, '', 'utf8');
    ...
    expect(result.content).toContain(
      'You are an AI agent that brings the power of casualresearch',
    );
  });
