...
import { Config, GitService, Logger } from '@google/casualresearch-cli-core';
...
export interface OpenDialogActionReturn {
  type: 'dialog';
  dialog: 'auth' | 'theme' | 'editor' | 'privacy' | 'config';
}
 ...
 * content as a prompt to the casualresearch model.
 */
