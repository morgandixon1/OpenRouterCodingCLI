...
import { casualresearchClient } from '@google/casualresearch-cli-core';
...
describe('chatCommand', () => {
  ...
  beforeEach(() => {
    ...
    mockContext = createMockCommandContext({
      services: {
        config: {
          getProjectTempDir: () => '/tmp/casualresearch',
  ...
  describe('resume subcommand', () => {
    ...
    it('should resume a conversation', async () => {
      const conversation: Content[] = [
        { role: 'user', parts: [{ text: 'hello casualresearch' }] },
      ...
      expect(result).toEqual({
        type: 'load_history',
        history: [
          { type: 'user', text: 'hello casualresearch' },
          { type: 'casualresearch', text: 'hello world' },
