...
describe('bugCommand', () => {
  beforeEach(() => {
    ...
    vi.stubEnv('SANDBOX', 'casualresearch-test');
  });
...
* **Model Version:** casualresearch-pro
* **Memory Usage:** 100 MB
`;
    const expectedUrl =
      'https://github.com/google-casualresearch/casualresearch-cli/issues/new?template=bug_report.yml&title=A%20test%20bug&info=' +
