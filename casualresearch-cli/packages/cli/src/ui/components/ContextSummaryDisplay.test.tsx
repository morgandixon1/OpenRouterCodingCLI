...
describe('<ContextSummaryDisplay />', () => {
  const baseProps = {
    casualresearchMdFileCount: 1,
    contextFileNames: ['casualresearch.md'],
  ...
  it('should render on a single line on a wide screen', () => {
    ...
    expect(output).toContain(
      'Using: 1 open file (ctrl+e to view) | 1 casualresearch.md file | 1 MCP server (ctrl+t to view)',
    );
