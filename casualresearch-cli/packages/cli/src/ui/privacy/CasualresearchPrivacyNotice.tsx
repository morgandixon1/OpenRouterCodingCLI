...
interface CasualresearchPrivacyNoticeProps {
  onExit: () => void;
}

export const CasualresearchPrivacyNotice = ({ onExit }: CasualresearchPrivacyNoticeProps) => {
  useInput((input, key) => {
    if (key.escape) {
      onExit();
    }
  ...
  return (
    <Box flexDirection="column" marginBottom={1}>
      <Text bold color={Colors.AccentPurple}>
        casualresearch API Key Notice
      </Text>
      <Newline />
      <Text>
        By using the casualresearch API<Text color={Colors.AccentBlue}>[1]</Text>,
        Google AI Studio
        ...
        <Text color={Colors.AccentGreen}>[3]</Text>, and the casualresearch API
      ...
      <Text>
        ...
        https://ai.google.dev/docs/casualresearch_api_overview
      </Text>
      <Text>
      ...
      <Text>
        <Text color={Colors.AccentPurple}>[4]</Text>{' '}
        https://ai.google.dev/casualresearch-api/terms
      </Text>
      <Newline />
