...
// File for 'casualresearch mcp add' command
import type { CommandModule } from 'yargs';
import { loadSettings, SettingScope } from '../../config/settings.js';
import { MCPServerConfig } from '@google/casualresearch-cli-core';
...
export const addCommand: CommandModule = {
  ...
  builder: (yargs) =>
    yargs
      .usage('Usage: casualresearch mcp add [options] <name> <commandOrUrl> [args...]')
      .positional('name', {
