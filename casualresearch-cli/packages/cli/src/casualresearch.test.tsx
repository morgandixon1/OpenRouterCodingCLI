...
describe('casualresearch.tsx main function', () => {
  let consoleErrorSpy: ReturnType<typeof vi.spyOn>;
  let loadSettingsMock: ReturnType<typeof vi.mocked<typeof loadSettings>>;
  let originalEnvcasualresearchSandbox: string | undefined;
  ...
  beforeEach(() => {
    ...
    originalEnvcasualresearchSandbox = process.env.casualresearch_SANDBOX;
    originalEnvSandbox = process.env.SANDBOX;
    delete process.env.casualresearch_SANDBOX;
  ...
  afterEach(() => {
    ...
    if (originalEnvcasualresearchSandbox !== undefined) {
      process.env.casualresearch_SANDBOX = originalEnvcasualresearchSandbox;
    } else {
      delete process.env.casualresearch_SANDBOX;
    }
