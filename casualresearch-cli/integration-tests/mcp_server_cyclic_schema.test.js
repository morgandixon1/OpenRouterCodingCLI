...
/**
 * This test verifies we can match maximum schema depth errors from casualresearch
...
describe('mcp server with cyclic tool schema is detected', () => {
  ...
  test('should error and suggest disabling the cyclic tool', async () => {
    ...
    // casualresearchChat.ts to see if it needs to be updated.
    // Or, possibly it could mean that casualresearch has fixed the issue.
